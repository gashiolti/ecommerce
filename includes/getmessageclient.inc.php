...
error_reporting(0); // hide error messages
    ...
    if(isset($_SESSION['userID']) && isset($_SESSION['role'])) {
        if($_SESSION['role'] == 2) {
            ...
            echo "<div class='header-chat-wrapper' id='header-chat-wrapper'>";
            ...
            // echo "<br><br><br><br><br>";
            echo "<div class='main-bottom' id='main-bottom'>";   
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    if($row['from_user_id'] === $userID) {
                       echo "<div class='outgoing-message-wrapper'>
                        ...
                        echo "<div class='incoming-message'>
            ...
            // echo $output2;
            echo "</div>"; //close main-bottom div
            echo "</div>";//close header-chat-wrapper
            echo "<form class='myForm' id='myForm' autocomplete='off'>
                        <div class='main-deliver-message'>
                            ...
                            <button type='submit' name='send' class='send' onclick='myForm()'><i class='fas fa-paper-plane'></i></button>
                        </div>
                    </form>";
            echo "</div>";//close main-wrapper
            // echo "<script src='JS/jquery-3.5.1.js'></script>
    ...
    <script>
        ...
        // const chatBox = document.querySelector(".main-bottom");
        ...
        function myForm() {
            document.getElementById("myForm").onsubmit = function(e) {
                ...
                var value = document.querySelector('.receiver').value;
                var inputField = form.querySelector('.deliver-message');
                
                let xhr = new XMLHttpRequest(); //creating XML object
                xhr.open("POST", "includes/sendmessagehelpagent.inc.php?sendingto="+value, true);
                xhr.onload = ()=>{
