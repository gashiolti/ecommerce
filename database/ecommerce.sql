...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2021 at 06:01 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertUserInfo` (IN `inputemail` VARCHAR(50), IN `inputpassword_` VARCHAR(100), IN `inputfname` VARCHAR(35), IN `inputlast_name` VARCHAR(35), IN `inputroleID` INT, IN `inputage` SMALLINT, IN `inputgender` VARCHAR(15), IN `inputadress` VARCHAR(250), IN `inputcity` VARCHAR(50), IN `inputcountry` VARCHAR(50), IN `inputpostal_code` INT, IN `inputphone_nr` INT)  BEGIN
	INSERT INTO user_ (email, password_, fname, last_name, roleID)
    VALUES (inputemail, inputpassword_, inputfname, inputlast_name, inputroleID);
    
    INSERT INTO personal_info (userID, age, gender, adress, city, country, postal_code, phone_nr)
    VALUES (LAST_INSERT_ID(), inputage, inputgender, inputadress, inputcity, inputcountry, inputpostal_code, inputphone_nr);
END$$
...
(6, 30, 'Male', '70 Grange Road London NW35 7QJ', 'London', 'United Kingdom', 'N5V 1A6', '49531532'),
...
(12, 30, 'Female', '70 Grange Road London NW35 7QJ', 'London', 'UK', 'N5V 1A6', '175374933'),
...
(64, 'Samsung Galaxy Note 20 Ultra 5G', '1099.99', 5, 'SmartPhone', 'Samsung'),
(65, 'PlayStation 5', '699.99', 7, 'Console', 'PlayStation'),
(66, 'Laptop HP i9, 16GB Ram, RTX 3070 ', '1899.99', 3, 'Laptop', 'HP'),
...
(76, 'Iphone 11 PRO Max 256 GB', '1199.99', 11, 'SmartPhone', 'Apple'),
...
(80, 'Iphone SE 2 64GB', '599.99', 8, 'SmartPhone', 'Apple'),
...
('2021-03-17 18:04:16', 22, 5, 1),
('2021-03-19 17:24:28', 23, 5, 1);
...
(6, 'filan@gmail.com', '$2y$10$qDklBg7hZHU66oenZK/g..K36OGFdBNXIVNKbI0fzRGfu1c04bsDW', 'Filan', 'Fisteku', 3),
...
(12, 'joewilliam@gmail.com', '$2y$10$x8xk7rn8Uoq4dw4kAjgCSe1gvpOV3qbYasaPkrHM0wuIDSOEDHPUO', 'Joe', 'William', 3),
...
--
ALTER TABLE `shoppingcart`
  MODIFY `shcID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
